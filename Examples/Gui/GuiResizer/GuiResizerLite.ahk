;SOURCE: https://www.autohotkey.com/boards/viewtopic.php?style=19&t=133754
;
;TODO:  Error when WinMinimize / Restore
;
...
__Test_GuiResizer() {
    ...
    __Tests_GuiResizer := true ;false

    if !__Tests_GuiResizer
        SoundBeep(), ExitApp()
    ...
    Test1() {
        ...
        /* example  */
        g := Gui('+Resize +Owner +AlwaysOnTop')
        g.Add('Edit', 'x10 y10 w400 h200 vedit')
        g.Add('Button', 'x420 y10 w100 h25 vbtn1', 'Button 1')
        g.Add('Button', 'w100 h25 vbtn2', 'Button 2')
        g.Add('Button', 'w100 h25 vbtn3', 'Button 3')
    ...
    Test3() {
        ...
        ; fixed size Gui, move button only
        ...
        ;myBtn1 := g.Add('Button', 'x420 y10 w100 h25', 'Button 1')
        myBtn1 := g.Add('Button', 'xm w100 h25', 'Button 1')
        btn1Params := {ctrl: myBtn1, x: 1}

        myBtn2 := g.Add('Button', 'yp w100 h25', 'Button 2')
        btn2Params := {ctrl: myBtn2, x: 1}

        ;params := [edit1Params, edit2Params, edit3Params, btn1Params, btn2Params, btn3Params]
        params := [btn1Params, btn2Params]
        resizer := GuiResizer(g, params)

        ;show gui and note Button 1 moved to the right side
        g.OnEvent('Size', resizer.Set)
        g.Show()

        myEdit1.Text:="This is a fixed size Gui`r`nNote Button 1 moved to the right side of the Gui?"
        myEdit1.Text.="`r`n`r`n(Well, this is WIP...)"
