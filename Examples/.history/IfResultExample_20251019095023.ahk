...
ChangeConsoleFont_4() {
    ...
    if (hConsole = -1) {
        ConsoleWriteLine "Failed to get console handle.", "Error", "IconError"
        ExitApp
    }
    ...
    if (result = 0) {
        ConsoleWriteLine "Failed to change console font. Error: " DllCall("GetLastError"), "Error", "IconError"
    }
