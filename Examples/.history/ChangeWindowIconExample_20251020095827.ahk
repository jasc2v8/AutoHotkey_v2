...
ChangeWindowIcon(IconFile, IconNumber:="Icon1", WinTitle := "A") {
    ...
    if (OutExt = "ico")
        hIcon := LoadPicture(IconFile,, &IconType)
    else if (OutExt = 'dll')
...
ChangeWindowIcon_Test1() {
    ...
    file := "C:\Windows\SystemApps\MicrosoftWindows.Client.Core_cw5n1h2txyewy\StartMenu\Assets\UnplatedFolder\UnplatedFolder.ico"
    r :=ChangeWindowIcon(file, "ahk_id" hWnd)
    Console.WriteLine("Result Gui Unplted Folder: " r)
