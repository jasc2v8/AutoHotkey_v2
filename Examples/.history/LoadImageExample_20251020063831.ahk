...
;hIcon0 := LoadPicture("C:\Windows\System32\OneDrive.ico", "Icon1")
hIcon0 := LoadPicture("C:\Windows\System32\MarkDownFile.ico", "Icon1")
...
MyGui := Gui()
;MyGui.AddPicture("w32 h-1", "HICON:" hIcon0)
MyGui.AddPicture("w32 h-1", "HBITMAP:*" hIcon0)
