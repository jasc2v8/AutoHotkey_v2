...
Test1() {
    ...
    hIcon := LoadPicture("C:\Windows\System32\shell32.dll", "Icon16")
        WM_SETICON := 0x80
        ICON_SMALL := 0
        ICON_BIG := 1

        ; Set the Small Icon (Taskbar/Title Bar)
        SendMessage(WM_SETICON, ICON_SMALL, this.hIcon,, "ahk_id " ScriptHwnd)

        ; Set the Big Icon (Alt+Tab Switcher)
        SendMessage(WM_SETICON, ICON_BIG, this.hIcon,, "ahk_id " ScriptHwnd)
