...
/*
    TODO:
        not setting the font upon LoadIni
        not displaying the font size again: Consolas SB Consolas 18
...
g.AddText("xm w712 h2 0x10","Horizontal Line")  ;SS_ETCHEDHORZ
...
InitializeIni() {
    ...
    if !IsSet(INI)
        INI := IniLite() ; Default is A_ScriptFullPath.SplitPath().NameNoExt ".ini"
