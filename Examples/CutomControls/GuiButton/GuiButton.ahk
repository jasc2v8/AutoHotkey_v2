;SOURCE: https://www.autohotkey.com/boards/viewtopic.php?f=83&t=115871&p=601952&hilit=GuiButtonIcon#p601952
...
MyFunction__Tests() {
    ...
    MyButton1.OnEvent('Click', Button_Click)
    MyButton2.OnEvent('Click', Button_Click)
    MyButton3.OnEvent('Click', Button_Click)
    MyButton4.OnEvent('Click', Button_Click)
    MyButton5.OnEvent('Click', Button_Click)

    MyGui.Show

    Button_Click(Ctrl, Info) {
        msg := Ctrl.Text ? Ctrl.Text : 'No Text'

        MsgBox 'Button Clicked: ' msg
