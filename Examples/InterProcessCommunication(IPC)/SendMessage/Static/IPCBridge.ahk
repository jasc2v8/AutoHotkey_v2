...
class IPCBridge {
     ...
     */
    static Listen(Role, UniqueName, SECRET_KEY, Callback) {
     ...
     */
    static Send(Target, Text, Timeout := 1000) {
    ...
    static _OnReceive(wParam, lParam, msg, hwnd) {
        ...
        ; We use IPCBridge explicitly instead of 'this' for static reliability
