...
;MyGui.Add("Text", "xm y+m w-20 +0x10") ; Etched horizontal line that autosizes with the GUI
MyGui.Add("Text", "xm y+m h1 w812" " +0x9", "This is a test") ; Etched horizontal line that autosizes with the GUI
;MyGui.Add("Edit", "W y+m")
;MyGui.Add("Text", "w" width, "THIS IS A TEST") ; Etched horizontal line that autosizes with the GUI
;MyGui.Add("Text", "xm +0x10","TEXT") ; Etched horizontal line that autosizes with the GUI
;MyGui.Add("Text", "xm y+m w-20 +0x10") ; Etched horizontal line that autosizes with the GUI
...
;used to determine the width of the Text control
;MyGui.GetPos(,, &w, &h)
