...
Class Gui2 extends Gui{
	...
	AddListeningRadio(options, Text, callback ) {
		super.AddRadio(options " v" Text, Text)
		this[Text].onEvent("Click", callback)
	}
	AddButton(options,Text, Callback) {
		super.AddButton(options,Text)
		this[Text].onEvent("Click", Callback)
	}
	Call(*) {
		this.xVal := "x" . this.xValue 
		this.yVal := "y" . this.yValue 
		SetWindowTheme(this)
		;this.Show(this.yVal this.xVal)
		this.Show("w400 h200")
