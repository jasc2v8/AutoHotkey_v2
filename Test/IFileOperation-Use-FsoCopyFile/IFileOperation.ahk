...
class IFileOperation
{
    ...
    ; ===================================================================================================================
    static IID_IShellItem := Buffer(16)
    ...
    __New()
    {
        ...
        this.Ptr := ComObject("{3AD05575-8857-4850-9277-11B85BDB8E09}", "{947AAB5F-0A5C-4C13-B4D6-4BF7836FC9F8}")
        if (!this.Ptr)
            throw Error("IFileOperation class.", -1)
    ...
    */
    ...
    {
        if !IsObject(Item:=IFileOperation.ItemFromName(FileName)) || !IsObject(Dest:=IFileOperation.ItemFromName(DestName))
