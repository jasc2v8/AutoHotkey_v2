...
;@Ahk2Exe-Set ProductVersion, 0.0.0.31
...
DoSelectFile(Item) {
    ...
    ;DEBUG
    root := editBoxIss.Text
    MsgBox("root: " root, "root")

    SelectedFile := FileSelect(1+2, root, 
    ...
    if (Item == "AHK") {
        ...
        version := DoReadSetting(editBoxAhk.Text,
            ";@Ahk2Exe-Set ProductVersion,")
        editBoxIssExe.Text := DoGetIssExeFileName(editBoxAhk)
        ;'' StrReplace(SelectedFile,            ".ahk", "_setup_v" version ".exe")
    }
}
