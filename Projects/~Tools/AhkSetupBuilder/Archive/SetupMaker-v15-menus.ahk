...
MenuHandler(Item, *) {
    ...
    ;if GetKeyState('Shift', 'P')        item := Item " (Shift)"

    switch Item {

        case "▽▽▽ Click=SELECT, Shift+Click=EXPLORE:":
            MsgBox("DEBUG: You selected " Item)
        ...
        case "Select EXE":
            MenuSelectExeClicked(Item)
            
        case "Select ISS":
            MenuSelectIssClicked(Item)
