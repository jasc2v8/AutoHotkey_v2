...
;@AHK2EXE_PATH-Set ProductVersion, 0.0.0.32
...
DoGetAhkVersion(ahkFile) {
    ;     if version in filename
    ;     Gui.Title := filename version _v0.0.0.32
    ;     icon := filename.NameNoExt ".ico"
    ; else
    ; else
    ;     Gui.Title := MyProductVersionIntheGuiTitle
