...
buttonMakeClicked(Ctrl, Info) {
    ...
    MsgBox("newGUID: " newGUID, "DEBUG", "OK Icon!")
    ...
    newIssPath := SplitPathObj(issPath).Dir "\" exeNameNoExt ".iss"

    ;MsgBox("newIssPath: " newIssPath, "DEBUG", "OK Icon!")

    ;MsgBox("issText:`n`n" issText, "DEBUG", "OK Icon!")
    ...
    MsgBox("CHECK RESULTS", "DEBUG", "OK Icon!")

    ; make setup: "C:\Program Files (x86)\Inno Setup 6\ISCC.exe" {exe_path}\exeName_Setup_v1.0.0.0.exe
