...
Gui_Size(thisGui, MinMax, Width, Height) {
    ...
    ; Freeze GUI updates
    DllCall("SendMessage", "ptr", thisGui.Hwnd, "uint", 0x0B, "ptr", 0, "ptr", 0) ; WM_SETREDRAW = 0
    ...
    ; Unfreeze + Force repaint
    DllCall("SendMessage", "ptr", thisGui.Hwnd, "uint", 0x0B, "ptr", 1, "ptr", 0)   
    DllCall("RedrawWindow", "ptr", thisGui.Hwnd, "ptr", 0, "ptr", 0, "uint", 0x85) ; RDW_INVALIDATE|RDW_UPDATENOW
}
...
ExecuteScript(AsAdmin) {
    ...
    TempFile := A_Temp "\usr_output_" A_TickCount ".txt"
