...
#Include <String_Functions> ; Test only, not in the real script
...
;
;
; #region TEST StrContains String_Functions
;
;
;
if StrContains(INI_PATH, "BackupTool")
  MsgBox "contains", "test"
...
StartBackup() {
  ...
  BackupRequest:= RunShell.ToCSV(SyncBackPath, SyncBackPostAction, SyncBackSelectedProfile)
