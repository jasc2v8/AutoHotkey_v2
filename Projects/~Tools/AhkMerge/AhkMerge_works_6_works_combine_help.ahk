...
myGui.AddButton("yp w75", "Help").OnEvent("Click", (*) => ShowHelp())

myGui.AddButton("xs w75", "Combine").OnEvent("Click", (*) => CombineScripts())
...
CombineScripts() {
    ...
    if selectedFiles.Length >0 {
        ...
        r := MsgBox("Files to Combine:`n`n" text, "CombineScripts", "YesNo Icon?")
        if (r="No")
            return
