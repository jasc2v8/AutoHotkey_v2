...
; source AHKV1: https://www.autohotkey.com/boards/viewtopic.php?t=108540
; TODO: Started by FEEBLE attempt to conver to V2 but INOP

#Include <AhkFunctions> ; Include the file containing the function
...
Local  File, Var, mDC, sizeofRGBQUAD, ICONINFO:=[], BITMAP:=[], BITMAPINFOHEADER:=[]
  ...
  VarSetStrCapacity(&Var,32)                                          ; ICONINFO Structure
  ...
  If ( BITMAP.bmBitsPixel <= 8 )                                    ; Bitmap uses a Color table!
  {
      ...
      VarSetStrCapacity(&Var,sizeofRGBQUAD)
  ...
  capacity := A_PtrSize= 8 ? 104:84
  VarSetStrCapacity(&Var, capacity)
