...
MainGui := Gui("+AlwaysOnTop", "Process Exist Checker")
MainGui.SetFont("s9", "Segoe UI")

MainGui.Add("Text",, "Enter PID or Name")
; Added default title "AhkLauncher"
EditTitle := MainGui.Add("Edit", "w300 vWinTitle", "SyncBackSE.exe")
...
BtnCheck.OnEvent("Click", CheckProcess)
...
CheckProcess(*) {
    ...
    if ProcessExist(Saved.WinTitle)
    {
