...
; --- GUI Creation ---
MyGui := Gui("+Resize +MinSize520x400 +0x02000000", "Universal Script Runner v6.8.1")
...
; Top Row: Path Display (V6.8 Style)
MyGui.Add("Text", "vTxtSelected w130", "Selected Script:")
; Width set to match editor width minus scrollbar area
EditPath := MyGui.Add("Edit", "vEditPath w640 r1 ReadOnly", FullPath)
...
Gui_Size(thisGui, MinMax, Width, Height) {
    ...
    ; Top Row - Width adjusted to align with editor minus scrollbar
    EditPath.Move(,, Width - 130 - margin - scrollBarWidth)
