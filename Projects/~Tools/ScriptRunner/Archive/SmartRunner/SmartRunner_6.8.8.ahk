...
; --- GUI Creation ---
MyGui := Gui("+Resize +MinSize520x400 +0x02000000", "Universal Script Runner v6.8.8")
...
; Top Row: Path Display (Now Editable)
EditPath := MyGui.Add("Edit", "vEditPath xm w760 r1", FullPath)
...
Gui_Size(thisGui, MinMax, Width, Height) {
    ...
    ; EditPath width matches Editor minus scrollbar
...
SelectFile(*) {
    ...
    ; Determine root folder from current EditPath value
...
ReloadFile(*) {
    ; Refresh FullPath from the editable EditPath box
