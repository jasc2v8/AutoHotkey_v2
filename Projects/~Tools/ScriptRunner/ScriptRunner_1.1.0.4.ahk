...
;@Ahk2Exe-Set FileVersion, 1.1.0.4
;@Ahk2Exe-Set ProductVersion, 1.1.0.4
...
; --- GUI Creation ---
MyGui := Gui("+Resize +MinSize520x400 +0x02000000", "Script Runner v1.1.0.4")
...
AddToRecent(path) {
    ...
    Loop Min(10, history.Length)
        reg.Write("Recent", history[A_Index])
