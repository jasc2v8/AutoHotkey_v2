...
logger:= LogFile("D:\SearchBarReset.log", "CONTROL", true)
...
if (A_IsAdmin) {
    ...
    runner:= RunAdmin()
    runner.StartTask()
    runner.RunWait("D:\Software\DEV\Work\AHK2\Projects\~Tools\SearchBarReset\SearchBarReset.ahk,") ; note CSV
