...
; -------------------------------------------------------------------------------------------------------------
#define MyAppFilePath     "D:\Software\DEV\Work\AHK2\Projects\DownloadControlTool\DownloadControlTool.exe"		           
#define MyAppIconPath     "D:\Software\DEV\Work\AHK2\Projects\DownloadControlTool\DownloadControlTool.ico"		       
#define MyAppName         "DownloadControlTool.exe"           
#define MyAppNameNoExt    "DownloadControlTool" 
#define MyAppPublisher    "jasc2v8"      
#define MyCompanyName     "jasc2v8"		         
#define MyFileDescription "Download Control Tool"    
#define MyFileVersion     "1.0.1.2"        
#define MyInternalName    "DownloadControlTool" 
#define MyLanguage        "English (United States)"           
#define MyLegalCopyright  "©2025 jasc2v8"          
#define MyLegalTrademark  "NONE™"    
#define MyInnoId          "{{09F686C0-6F29-43BC-88D4-0C51BEFEEB4B}}"						 
#define MyOutputDir       "D:\Software\DEV\Work\AHK2\Projects\DownloadControlTool"	       
#define MyOutputFilename  "DownloadControlTool_setup_v1.0.1.2"	   
#define MyProductName     "DownloadControlTool"        
#define MyProductVersion  "1.0.1.1"     
