...
; --- GUI Setup ---
MyGui := Gui("+Resize", "Icon Viewer v1.0")
...
LB := MyGui.Add("ListBox", "x10 y75 w120 r15 +Sort", CommonLibs)
LB.OnEvent("Change", (Ctrl, *) => LoadIcons(A_WinDir "\System32\" . Ctrl.Text))

LV := MyGui.Add("ListView", "x140 y75 w600 r15 +Icon +VScroll", ["Index", "Name"])
...
UpdateTitle(Count := -1) {
    MyGui.Title := "Icon Browser Ultimate"
    UpdateStatus()
}
