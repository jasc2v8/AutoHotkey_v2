...
;@Ahk2Exe-Set FileVersion, 3.3.0.16
...
;@Ahk2Exe-Set ProductVersion, 3.3.0.16
...
SyncBackParams.Profile := INI.ReadSettings("PROFILE")
...
StartBackup() {
  ...
  BackupRequest:= myRun.ToCSV(SyncBackParams.Path, SyncBackParams.Profile)
...
ButtonSelectProfile_Click(Ctrl, Info) {
  ...
  if (selection != "") {
    ...
    INI.WriteSettings("PROFILE", OutNameNoExt)
  }
}
