; TITLE   : BackupTool v3.3.0.3 with ProcessMonitor and WatchCursorGui
...
OnFinishedNotify(Reason) {
    WriteStatus(Reason . " at: " FormatTime(A_Now, "HH:mm:ss") ", Elapsed: " pm.Elapsed)
...
OnStatusNotify(Status) {
    WriteStatus("Backup then " SyncBackParams.PostAction . " " . Status . " at: " FormatTime(A_Now, "HH:mm:ss") ", Elapsed: " pm.Elapsed)
}
