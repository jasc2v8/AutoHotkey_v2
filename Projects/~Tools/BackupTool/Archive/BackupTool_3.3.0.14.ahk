...
;@Ahk2Exe-Set FileVersion, 3.3.0.14
...
;@Ahk2Exe-Set ProductVersion, 3.3.0.14
...
MyGui.BackColor := Colors.MyGuiBackground
...
;MyGui.BackColor := "72A0C1" ; Air Superiority Blue
;MyGui.BackColor := "5D89BA" ; Silver Lake Blue / Dusty Denim Blue

; #region Create Controls

MyGui.SetFont("S10", "Segouie UI")
TextProfile := MyGui.AddEdit('xm w410 h20 Center ' Colors.MyBackgroundLemon, SyncBackSelectedProfile) ; #ffeaa7 Sour Lemon (flatuicolors)
