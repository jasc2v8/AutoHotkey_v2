...
;@Ahk2Exe-Set FileVersion, 3.3.0.9
...
;@Ahk2Exe-Set ProductVersion, 3.3.0.9
...
TextProfile := MyGui.AddEdit('xm w410 h20 Center BackgroundF1EB9C', SyncBackSelectedProfile)
