; TITLE   : BackupControlWorker v9.0
; SOURCE  : jasc2v8 and chatGPT
; LICENSE : The Unlicense, see https://unlicense.org
; PURPOSE : BackupControlTool runs SyncBack.exe who communicates with this BackupControlWorer using NamedPipe IPC.
...
;@Ahk2Exe-SetMainIcon D:\Software\DEV\Work\AHK2\Projects\~Tools\BackupControlTool\Icons\Cogs.ico
...
logger.Write("START BackupControlWorker")
