...
;@Ahk2Exe-Set FileVersion, 3.0.0.3
...
;@Ahk2Exe-Set ProductVersion, 3.0.0.3
...
MyGui := Gui("-AlwaysOnTop", "Backup Tool " Version)
...
ButtonCommon_Click(Ctrl, Info){
  ...
  if (timedOut) {
    ...
    launcher.RunWait(BackupRequest)
