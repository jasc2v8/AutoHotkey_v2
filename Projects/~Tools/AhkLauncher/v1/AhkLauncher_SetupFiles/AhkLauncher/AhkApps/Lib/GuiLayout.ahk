    ...
    static Row(MyGui, Controls, Layout) {
        ...
        if (Layout = "AlignFill") {
            ...
            for control in Controls {
                ...
                ;FillWidth := Round(this.clientW + this.controlW/ Controls.Length) ;+ this.guiMarginX
                ;FillWidth := Round(this.clientW / (Controls.Length  * this.controlW)) ;+ this.guiMarginX
               
                ;FillWidth := (this.clientW / Controls.Length) - this.controlW 
                FillWidth := 32
                ctrlX := this.controlX + (FillWidth * A_Index)

                OutputDebug FillWidth ", " ctrlX
    ...
    count := 5
            switch count {
                ...
                case 2:
                    ...
                    WinRedraw(MyGui)
                case 3:
                    GuiLayoutEx.Row(MyGui, [MyGui["Yes"], MyGui["No"], MyGui["All"], MyGui["Cancel"]], "AlignCenter")
                ...
                case 4:
                    ...
                    WinRedraw(MyGui)
                case 5:
                    GuiLayoutEx.Row(MyGui, [MyGui["Yes"], MyGui["No"], MyGui["All"], MyGui["Cancel"]], "AlignFill")
