...
;@Ahk2Exe-Set FileDescription, Power Tool
;@Ahk2Exe-Set FileVersion, 1.0.0.1
;@Ahk2Exe-Set InternalName, PowerTool
;@Ahk2Exe-Set Language, 1033
;@Ahk2Exe-Set LegalCopyright, ©2025 jasc2v8
;@Ahk2Exe-Set LegalTrademarks, NONE™
;@Ahk2Exe-Set OriginalFilename, PowerTool.exe
;@Ahk2Exe-Set ProductName, PowerTool
;@Ahk2Exe-Set ProductVersion, 1.0.0.1
;@Ahk2Exe-SetMainIcon PowerTool.ico

;@Inno-Set AppId, {{B4292E30-2FBD-4C82-9EFC-B01AEC0B52F2}}
...
MyGui := Gui("+AlwaysOnTop", "Power Tool v1.0") ; "ToolWindow" does not have tray icon
