...
; -------------------------------------------------------------------------------------------------------------
#define MyAppFilePath     "D:\Software\DEV\Work\AHK2\Projects\~Tools\PowerTool\PowerToolMini.exe"		           
#define MyAppIconPath     "D:\Software\DEV\Work\AHK2\Projects\~Tools\PowerTool\PowerToolMini.ico"		       
#define MyAppName         "PowerToolMini.exe"           
#define MyAppNameNoExt    "PowerToolMini" 
#define MyAppPublisher    "jasc2v8"      
#define MyCompanyName     "jasc2v8"		         
#define MyFileDescription "Power Tool Mini"    
#define MyFileVersion     "1.0.0.2"        
#define MyInternalName    "PowerToolMini" 
#define MyLanguage        "English (United States)"           
#define MyLegalCopyright  "©2025 jasc2v8"          
#define MyLegalTrademark  "%LegalTrademarks%"    
#define MyInnoId          "{{F97722EF-93DE-46A2-A95C-2A69609DF4D7}}"						 
#define MyOutputDir       "D:\Software\DEV\Work\AHK2\Projects\~Tools\PowerTool"	       
#define MyOutputFilename  "PowerToolMini_setup_v1.0.0.2"	   
#define MyProductName     "PowerToolMini"        
#define MyProductVersion  "1.0.0.2"     
