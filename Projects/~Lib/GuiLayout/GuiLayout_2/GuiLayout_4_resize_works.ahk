...
;object or ClassNN?
        ...
        Gui_Size(GuiObj, MinMax, Width, Height) {
            ...
            try {
                ...
                ctrl := GuiLayout._GetControlPos(GuiObj["Yes"])
            ...
            GuiLayout.MoveControl(MyDivider, , newY, newW, , Redraw:=False)
            ...
            GuiLayout.MoveControl(GuiObj["Text"], , , newW, newH, Redraw:=False)

                ; Fill the edit to the client width
            GuiLayout.MoveControl(GuiObj["Edit"], , , newW, , Redraw:=false)
