...
Class GuiLayout {
    ...
    static GC(MyGui, ControlType:="Button") {
        return this.GetControls(MyGui, ControlType)
    }
    ...
    static MoveColumn(Controls, Layout, newX:="", newY:="", newW:="", newH:="", Redraw:=False) {
        ; TODO
    }
