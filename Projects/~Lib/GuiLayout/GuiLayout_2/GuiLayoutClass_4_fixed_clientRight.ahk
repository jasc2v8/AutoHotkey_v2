...
__GuiLayout_Test() {
    ...
    Test1() {
        ...
        MyButtonYes := MyGui.AddButton("Default", "Yes").OnEvent("Click", OnButton_Click)
        ;MyGui.AddButton("", "No")
        ;MyGui.AddButton("", "All")
        ...
        OnButton_Click(*) {
            ...
            /*
                Text control    : w:= L.Pos().ClientRight - RightMargin
                Button control  : x:= L.Pos().ClientWidth - L.Pos("Yes").ControlWidth  - L.Pos().BorderWidth
            ...
            */
            ...
            w:= L.Pos().ClientRight - L.Pos("Text").ControlX
            L.Move("Text", , , w,)
            L.Move("Divider", , , w,)

            x:= L.Pos().ClientRight - L.Pos("Yes").ControlWidth
            ; - RightMargin
            L.Move("Yes", x, , ,)
