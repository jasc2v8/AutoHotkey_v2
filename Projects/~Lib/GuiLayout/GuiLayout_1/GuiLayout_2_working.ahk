...
Class GuiLayout {
    ...
    static RowTest(MyGui, Controls, Layout) {
        ...
        ; L = Left = LeftToRight = LeftJustify = LeftFlow = LeftAlign, etc.
        ; Layout := SubStr(Layout, 1 ,1) = 'L' ? "AlignLeft"   : Layout
        ; Layout := SubStr(Layout, 1 ,1) = 'C' ? "AlignCenter" : Layout
        ; Layout := SubStr(Layout, 1 ,1) = 'R' ? "AlignRight"  : Layout
        ; Layout := SubStr(Layout, 1 ,1) = 'F' ? "AlignFill"  : Layout
