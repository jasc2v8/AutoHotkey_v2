; Source : https://github.com/ismael-miguel/AHK-ini-parser
	...
	class IniData {
		...
		SetValue(value_name, value, section_name)
		{
			...
			if (!this.data[section_name].HasKey(value_name))
			{
				...
				this.data[section_name][value_name] := Map("value", value, "comment", "")
			}
			else
			{
...
; =========================================================
	...
	class IniParser {
		...
		ParsedLineIntoData(parsed_line, data)
		{
			...
			data[parsed_line.name] := Map("value", parsed_line.value, "comment", parsed_line.comment)
			return data
		}
		...
		ParseSection(line)
		{
			...
			section_data := Map("section", "", "name", "", "value", "", "comment", "")
		...
		ParseValue(line)
		{
			...
			value_data := Map("section", "", "name", "", "value", "", "comment","")
		...
		ParseComment(line)
		{
			...
			return Map("section:", "", "name", "", "value:", "comment:", LTrim(line, "; `t"))
		}
	}
