...
;output := SmartRun(["D:\TEST\StdOut Args.exe", "-switch", "D:\List Vars.ahk", "D:\ShowArgs.exe"])


output := SmartRun.RunShellConsole("D:\TEST\StdOutArgs.exe one two three")

; ok output := SmartRun(["ipconfig", "/all"])
;output := SmartRun(["dir", "x:\"]) ; force StdErr
