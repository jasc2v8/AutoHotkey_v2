...
Msg(Text:="",Title:="",Buttons:="", Size:="", Opt:="",BackColor:=BackColor:="",
...
MsgCmd(Text:="",Title:="",Buttons:="", Size:="", Opt:="",BackColor:=BackColor:="",
 	 			TextOpt:="",TextFontOpt:=TextFontOpt:="",ButtonFontOpt:="",Icon:="", Sound:="") {
    BackColor := "0x0C0C0C"
...
MsgMatrix(Text:="",Title:="",Buttons:="", Size:="", Opt:="",BackColor:=BackColor:="",
 	    TextOpt:="",TextFontOpt:=TextFontOpt:="",ButtonFontOpt:="",Icon:="", Sound:="") {
...
MsgTerminal(Text:="",Title:="",Buttons:="", Size:="", Opt:="",BackColor:=BackColor:="",
 	    TextOpt:="",TextFontOpt:=TextFontOpt:="",ButtonFontOpt:="",Icon:="", Sound:="") {
...
MsgC(Text:="",Title:="",Buttons:="", Size:="", Opt:="",BackColor:=BackColor:="",
 	 			TextOpt:="",TextFontOpt:=TextFontOpt:="",ButtonFontOpt:="",Icon:="", Sound:="") {
    BackColor := "0x0C0C0C"
    TextFontOpt := "s11  c0xCDD0B1, Consolas"
    Icon := "C:\Windows\System32\imageres.dll, Icon264" ; cmd prompt  265=with user 
...
MsgM(Text:="",Title:="",Buttons:="", Size:="", Opt:="",BackColor:=BackColor:="",
 	    TextOpt:="",TextFontOpt:=TextFontOpt:="",ButtonFontOpt:="",Icon:="", Sound:="") {
    BackColor := "0x0C0C0C" ;"Black"
    TextFontOpt := "s11 c03A062, Consolas"
    Icon := "C:\Windows\System32\imageres.dll, Icon145" ; Terminal with green graph   
...
MsgT(Text:="",Title:="",Buttons:="", Size:="", Opt:="",BackColor:=BackColor:="",
 	    TextOpt:="",TextFontOpt:=TextFontOpt:="",ButtonFontOpt:="",Icon:="", Sound:="") {
    BackColor := "0x012456" ; "Blue"
    TextFontOpt := "s11 cCDD0B1, Consolas"
    Icon  := "C:\Windows\System32\imageres.dll, Icon105" ; Terminal with blue backcolor ;Icon313" ; PS prompt with user
 ...
 class MsgBoxCustom
{
    ...
    ButtonOffset := 30            ; Offset between the right side of text and right edge of button
        ...
        BottomWidth := LeftMargin * (ButtonCount/2) + ButtonWidth * ButtonCount
