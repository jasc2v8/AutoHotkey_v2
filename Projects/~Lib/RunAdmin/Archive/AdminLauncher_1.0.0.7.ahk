...
class AdminLauncher {
    ...
    logger := LogFile("D:\AdminLauncher.log", "AdminLauncher", false)
...
If (A_LineFile == A_ScriptFullPath) {
    ...
    logger2 := LogFile("D:\cmdLine.log", "cmdLine", false)
    ...
    ;
    ; if args then form command line
    ;
