...
If (A_LineFile == A_ScriptFullPath) {
    ...
    if (A_Args.Length > 0 ) {
        ...
        logger3 := LogFile("D:\RunAdminArgsRun.log", "RunAdminArgsRun", true)

        ;
        ; Start the Admin Task
        ;
        logger3.Write("START TASK")
        ...
        logger3.Write("cmdLine: " commandCSV)
        ...
        logger3.Write("Running: " commandCSV)
