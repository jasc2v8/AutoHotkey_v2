...
;ok
;cmd := RunAnyOld.ToArray("D:\TEST\StdOut Args.exe", "-switch", "D:\List Vars.ahk", "D:\ShowArgs.exe")
;output := RunAnyOld(cmd)
...
; p2  := "D:\List Vars.ahk"
; p3  := "D:\ShowArgs.exe"
; cmd := RunAnyOld.ToCSV(exe, p1, p2, p3)
; output := RunAnyOld(cmd)
