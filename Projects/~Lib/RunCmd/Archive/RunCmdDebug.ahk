...
*/ 
#Include SmartRun.ahk

Esc::ExitApp()

; input := 'C:\Program Files\App.exe p1 "two words" p3 "C:\Path With Spaces\file.txt"'

; input := 'D:\Show Args.exe -switch "D:\List Vars.ahk"'
; out := SplitExeAndParams(input)

; msg := "Exe:`n" out.exe "`n`nParams:`n"
; for i, v in out.params
;     msg .= i ": " v "`n"

;MsgBox msg
;MsgBox out.exe ; "`n`n" out.params
;Run(out.exe " " out.params)
;Run('"D:\Show Args.exe" -switch "D:\List Vars.ahk" D:\ShowArgs.exe')
;Run('"D:\test\StdOutArgs.exe" -switch "D:\test\List Vars.ahk" D:\test\ShowArgs.exe')

output := SmartRun(["D:\TEST\StdOutArgs.exe", "-switch", "D:\List Vars.ahk", "D:\ShowArgs.exe"])
