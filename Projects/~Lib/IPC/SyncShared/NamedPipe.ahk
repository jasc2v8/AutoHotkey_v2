...
class NamedPipe
{
    PipeName := "\\.\pipe\Global\NamedPipe"
    Handle   := 0

    static SDDL := "D:(A;;GA;;;WD)" ; Everyone,  "D:(A;;GA;;;BU)(A;;GA;;;BA)" ; Users

    __New(IsServer:=false, PipeName:="")
    {
        ...
        MsgBox this.PipeName "`n`nExist: " this.PipeExist(this.PipeName)
    ...
    Create()
    {
        if this.PipeExist(this.PipeName)
