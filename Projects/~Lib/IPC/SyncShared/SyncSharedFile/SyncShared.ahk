...
class SyncShared {
    ...
    __New(IsServer:=false) {
        ...
        ; Setup Events
        this.hEventServer := DllCall("CreateEvent", "Ptr", SA, "Int", 0, "Int", 0, "Str", "EVENT_SERVER", "Ptr") ; ServerMessageSent
        this.hEventClient := DllCall("CreateEvent", "Ptr", SA, "Int", 0, "Int", 0, "Str", "EVENT_CLIENT", "Ptr") ; ClientMessageSent
