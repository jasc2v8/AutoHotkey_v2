...
class EventLib {
    static Create(eventName) {
        return DllCall("kernel32\CreateEventA", "Ptr", 0, "Int", 1, "Int", 0, "AStr", eventName, "Ptr") ; 1=Manual Reset
    }

    static Open(eventName) {
        return DllCall("kernel32\OpenEventA", "UInt", 0x1F0003, "Int", 0, "AStr", eventName, "Ptr") ; 0x1F0003=EVENT_ALL_ACCESS
    }
