...
#define MyAppFilePath "Launch_AutoGUI.exe"
#define MyAppIconPath "AutoGUI.ico"
#define MyAppId       "{{9D788BD7-FF4E-489E-9B81-82137D14D646}}
...
#define MyAppName "Auto GUI for AHK2"           ; My Application     ; Assembly.Product
#define MyAppExeName "Launch_AutoGUI.exe"   ; MyApplication.exe  ; Assembly.Title
#define MyAppFileName "Launch_AutoGUI"             ; MyApplication
#define MyAppPublisher "Leo Shen"         ; My Company         ; Assembly.Company
#define MyAppCopyright "Non-Commercial Use"       ; Copyright @ 2025   ; Assembly.Copyright
#define MyAppVersion "1.0"  ; 1.0.0              ; Assembly.AssemblyVersion
#define MyAppVersionInfo "1.0" ; 1.0.0              ; Assembly.ProductVersion
